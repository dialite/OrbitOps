...
export const inngest = new Inngest({ id: "OrbitOps" });
...
const syncWorkspaceMemberCreation = inngest.createFunction(
  { id: `sync-workspace-member-fromclerk` },
    ...
    await sendEmail({
      ...
      body: `<div style="max-width: 600px">
        ...
        <div style="border: 1px solid #ddd; padding: 12px 16px; border-radius: 6px; margin-bottom: 30px>
          ...
          <p style="margin: 6px 0">${new Date(
            task.due_date
          ).toLocaleDateString()}</p>
        </div>

        <a href="${origin}" style="background-color: #007bff; padding: 
        12px 24px; border-radius: 5px; color: #fff; font-weight: 600; font-size: 16px; text-decoration: none">View Task</a>
